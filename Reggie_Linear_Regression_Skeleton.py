...
possible_ms =[round(-10+round(x*0.1, 1), 1) for x in range(0, 201)] #your list comprehension here
#print(possible_ms)
...
possible_bs =[b/10 for b in range(-200, 201)] #your list comprehension here
#print(possible_bs)
...
for m in possible_ms:
    for b in possible_bs:
        curr_error=calculate_all_error(m, b, datapoints)
        if curr_error < smallest_error:
            smallest_error=curr_error
            best_b=b
            best_m=m
print("Best m is: {}".format(best_m))
print("Best b is: {}".format(best_b))
print("The smallest error is: {}".format(smallest_error))
